...
internal static class Endpoints
{
    ...
    {
        ApiVersioning.MapVersionedPut(app, "/persone/{id:int}", "PersoneUpdateInt", async (
                int id,
            ...
            builder => builder
                .Produces<V1.Features.Persone.GetByIdInt.PersonaDetailDto>(StatusCodes.Status200OK)
